...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p Antes de empezar a explorar el menú de contenido, lo invitamos a ver el siguiente video, que le dará un panorama general sobre las diferentes temáticas que se van a estudiar.
